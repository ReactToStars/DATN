...
$(document).ready(function () {
   ...
   subjectJS = new SubjectJS();

})

class SubjectJS extends BaseJS {
    constructor() {
        super();
        this.initEventsPage();
        //this.loadPosition();
    ...
    setDataUrl() {
        this.getDataUrl = "/api/v1/subject/";
        this.getCode = "";
    }
    ...
    filterData() {
        try {
            ...
            listData = cacheData.filter(function (item) {
                return (item["SubjectName"].toLowerCase()).includes(value.toLowerCase());
            });
