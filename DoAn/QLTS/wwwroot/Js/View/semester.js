...
$(document).ready(function () {
    ...
    semesterJS = new SemesterJS();

})

class SemesterJS extends BaseJS {
    constructor() {
        super();
        this.initEventsPage();
        //this.loadPosition();
    ...
    setDataUrl() {
        this.getDataUrl = "/api/v1/Semester/";
        this.getCode = "";
    }
    ...
    filterData() {
        try {
            ...
            listData = cacheData.filter(function (item) {
                return (item["OlogyName"].toLowerCase()).includes(value.toLowerCase());
            });
