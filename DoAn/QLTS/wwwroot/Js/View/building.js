...
$(document).ready(function () {
    ...
    buildingJS = new BuildingJS();

})

class BuildingJS extends BaseJS {
    constructor() {
        super();
        this.initEventsPage();
        //this.loadPosition();
    ...
    setDataUrl() {
        this.getDataUrl = "/api/v1/building/";
        this.getCode = "";
    }
    ...
    * */
    ...
    filterData() {
        try {
            ...
            var builds = $('#cbx_header option:selected ').val();
            listData = cacheData.filter(function (item) {
                return (item["BuildingName"].toLowerCase()).includes(value.toLowerCase()) && (builds ? item["BaseBuilding"] === builds : item["BaseBuilding"] != builds);
            });
